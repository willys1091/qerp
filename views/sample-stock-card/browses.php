...
<div class="ms-user-index">
    <?= GridView::widget([
        ...
        'toolbar' => [
            [
                'content' =>
                Html::a('<i class="glyphicon glyphicon-repeat"></i>', Url::to(['product/browse-product-default?mode=' . $mode . '&branchID=' . $branchID]), [
                ...
                'buttons' => [
                    'select' => function ($url, $model) {
                        return Html::a("<span class='glyphicon glyphicon-ok'></span>", "#", [
                            'class' => 'modal-doalog-select',//'WindowDialogSelect',
                            'data-value' => $model->productID,
