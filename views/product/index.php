...
$this->title = 'Master Product Inventory';
...
<div class="ms-product-index">
    ...
    'dataProvider' => $model->search(),
        ...
        'columns' => [
            ...
            [
                'attribute' => 'flagInventory',
                'width'=>'250px',
                'value' => 'parentCategory.flagInventory',
                // 'filter' => ArrayHelper::map(MsProductcategory::find()->where(['<>','productCategoryID', '4'])->andwhere(['<>','productCategoryID', '7'])->andwhere(['<>','productCategoryID', '9'])->all(), 'productCategoryID', 'ProductCategoryName'),
                // 'filterInputOptions' => [
                //     'prompt' => 'All'
                // ],
                'headerOptions' => ['style' => 'text-align: left']
