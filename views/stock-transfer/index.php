...
?>
<div class="tr-stocktransferhead-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'stockTransferNum',
                'headerOptions' => ['style' => 'text-align: left']
            ],
            [
                'attribute' => 'sourceWarehouseID',
                'width'=>'250px',
                'value' => 'sourceWarehouse.warehouseName',
            ...
            [
                'attribute' => 'destinationWarehouseID',
                'width'=>'250px',
