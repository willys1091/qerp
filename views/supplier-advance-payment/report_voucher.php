...
<body style="font-family: Eurostar">
    ...
    <div style="width: 40%; float: left; text-align: right; padding-top: 20px; ">
        No. : <?= $model[0]['supplierAdvancePaymentNum'] ?> <br/>
        <?php if ($model[0]['supplierAdvancePaymentDate']) echo "Tgl : ".date('d-M-Y', strtotime($model[0]['supplierAdvancePaymentDate'])); ?>
    </div>
    ...
    <table class="table-report" style="width: 100%; border: 2px solid black; margin-top: 20px; margin-bottom: 10px; border-collapse: collapse;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border-top: 1px solid black; width: 25%; text-align: right;">
                <?php 
                    $totalAmount = $modelDetail['amount'] * $modelDetail['rate'];
