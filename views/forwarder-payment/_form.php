    ...
    <div class="box box-primary box-solid">
        ...
        <div class="box-body">
            <div class="panel panel-default">
                <div class="panel-heading">Forwarder Payment Information</div>
                        ...
                        <div class="col-md-4">
                            <?=
                                $form->field($model, 'supplierID')->widget(Select2::classname(),[
                                    'data' => ArrayHelper::map(MsSupplier::find()->where('flagActive = 1 AND isForwarder = 1')->orderBy(new yii\db\Expression("REPLACE(supplierName, ' ', '') ASC"))->all(), 'supplierID', 'supplierName'),
                                    'options' => [
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Forwarder Payment Detail</div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <th style="width: 15%;">Import Duty Total</th>
                                        <th style="width: 15%;">
                                            <div class="row">
                                                Tax Amount
                                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class = "newinput-group">
                                                ...
                                                <?= Html::a("...", ['forwarder-payment/browsebysupplier'], [
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Forwarder Payment Summary</div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-8">
                        </div>
...
$refNumAjaxURL = Yii::$app->request->baseUrl. '/forwarder-payment/checkrefnum';
...
$('.refDetailInput-0').change(function(){
    ...
    var WHTAmount = parseInt(result['whtAmount']);
    var priceBeforeTax = parseInt(result['price']);
    var taxRate = parseInt(result['taxRate']);
    var advancedPayment = parseInt(result['advancedPayment']);
    var previousPayment = parseInt(result['previousPayment']);
    ...
    $('.detailPaidAmount').val(previousPayment);
...
function addRow(refNum, priceBeforeTax, taxRate, WHTAmount, subTotal, paid, outstanding, advancedPayment, payment){
    ...
    $('.tableDetailPrice').inputmask('decimal', {digits: 2, digitsOptional : false, autoGroup: true, groupSeparator: '.', radixPoint: ',', removeMaskOnSubmit : false});
...
$('.detailPaymentAmount').change(function(){
    var amount = $('.detailPaymentAmount').val().currencyToFloat();
    var outstanding = $('.detailOutstandingAmount').val().currencyToFloat();
