...
$this->title = 'Sales Quotation List';
        ...
        'columns' => [
		    ...
		    [
                ...
                'value' => function ($model) {
                    return $model['productName'].'('.$model['priceOffer'].')';
                },
                ...
                'buttons' => [
                    'select' => function ($url, $model) {
                        return Html::a("<span class='glyphicon glyphicon-ok'></span>", "#", [
                            ...
                            'data-return-value' => $model['salesQuotationNum'],
                            'data-return-text' => \yii\helpers\Json::encode([$model['salesQuotationNum'],$model['customerID'],$model['contactPerson']])
                        ]);
                    },
                ]
            ]
