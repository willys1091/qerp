    ...
    <div class="box box-primary box-solid">
        ...
        <div class="box-body">
            <div class="panel panel-default">
                <div class="panel-heading">Found Stock Adjustment Information</div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="input-group-btn">
                                                    <?= Html::a("...", ['product/browsebywarehouses'], [
...
$(document).ready(function () {
    ...
    var rowTemplate = "" +
        ...
        "   <td>" +
        "       <input type='text' class='form-control text-right tableDetailHPP' name='TrStockopnamehead[joinStockDetail][{{Count}}][HPP]' value='{{HPP}}' >" +
        "   </td>" +
            $deleteRow
        "</tr>";
    ...
    $('.detail-table .btnAdd').on('click', function (e) {
        ...
        if(RealQty < Qty ){
            bootbox.alert("Real Qty must not be smaller than Stock Qty ");
